...
<bbData:context id="ctx">
    <bbNG:genericPage title="config">
        ...
        <bbNG:inventoryList collection="${userList}" initialSortCol="userName"  objectVar="tmpuser" className="UserInfo" url="">

            <%-- <bbNG:listCheckboxElement name="ckbox" value="${tmpuser.xgh}" showCheckbox="true"/> --%>

            <bbNG:listElement label="姓名" name="userName" isRowHeader="true">
                ${tmpuser.userName}
            </bbNG:listElement>

            <bbNG:listElement label="年龄" name="age">
                ${tmpuser.age}
            </bbNG:listElement>
